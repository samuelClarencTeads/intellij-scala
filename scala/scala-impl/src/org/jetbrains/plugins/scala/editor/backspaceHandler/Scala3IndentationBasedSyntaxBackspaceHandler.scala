...
import com.intellij.codeInsight.editorActions.{BackspaceHandler, BackspaceHandlerDelegate, *}
...
import org.jetbrains.plugins.scala.editor.backspaceHandler.Scala3IndentationBasedSyntaxBackspaceHandler.*
...
object Scala3IndentationBasedSyntaxBackspaceHandler {
  ...
  private def findElementInIndentationContextOnPrevLine(
    ...
    val result = previousElementInIndentationContext(elementAtCaret, searchFromOffset, documentText, indentOptions)
    result.map(_._2)
  }
}