...
import org.jetbrains.plugins.scala.annotator.ScalaProblemFileHighlightFilter.*
import org.jetbrains.plugins.scala.externalHighlighters.{ExternalHighlighters, ScalaHighlightingMode}
